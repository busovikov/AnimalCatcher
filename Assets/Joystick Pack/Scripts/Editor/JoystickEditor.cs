...
public class JoystickEditor : Editor
{
    ...
    protected virtual void OnEnable()
    {
        ...
        output = serializedObject.FindProperty("joystickOutputEvent");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(output, new GUIContent("Joystick Output Event", "Call the event on joystick move"));
    }
